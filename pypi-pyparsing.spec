...
Source0  : https://files.pythonhosted.org/packages/8b/1a/3544f4f299a47911c2ab3710f534e52fea62a633c96806995da5d25be4b2/pyparsing-3.2.1.tar.gz
...
%prep
%setup -q -n pyparsing-3.2.1
cd %{_builddir}/pyparsing-3.2.1
pushd ..
cp -a pyparsing-3.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735831821
