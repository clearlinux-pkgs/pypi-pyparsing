...
Source0  : https://files.pythonhosted.org/packages/ab/61/1a1613e3dcca483a7aa9d446cb4614e6425eb853b90db131c305bd9674cb/pyparsing-3.0.6.tar.gz
...
Provides: pyparsing
Provides: pyparsing-python
Provides: pyparsing-python3
BuildRequires : nose
BuildRequires : py
...
%prep
%setup -q -n pyparsing-3.0.6
cd %{_builddir}/pyparsing-3.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641477325
...
cp %{_builddir}/pyparsing-3.0.6/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pyparsing/df156c6a0a89ed2a3bd4a473c68cf85907509ca0
